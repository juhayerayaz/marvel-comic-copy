        ...
        <div className='bg-[#202020]'>
            <div className='flex items-center justify-center border border-[#393939] border-x-0 border-t-0 h-[52px]'>
                <div className='flex items-center border border-[#393939] p-3 border-y-0 text-white'>
                    ...
                    <label htmlFor={modal} className="mx-2 text-xs font-semibold cursor-pointer uppercase" style={{ letterSpacing: '1px' }} onClick={handleSigninbtn}>Sign in</label>
                    |
                    <input type="checkbox" id={modal} className="modal-toggle" />
                    <div className="modal modal-bottom sm:modal-middle bg-black bg-opacity-70">
                    ...
                    <label htmlFor={modal2} className="mx-2 text-xs font-semibold cursor-pointer uppercase" style={{ letterSpacing: '1px' }} onClick={handleJoinbtn}>JOIN</label>
                    <input type="checkbox" id={modal2} className="modal-toggle" />
                    <div className="modal modal-bottom sm:modal-middle bg-black bg-opacity-70">
                        <div className="card w-[409px] bg-white px-10 py-9 rounded-none">
                            <label htmlFor={modal2} className="text-black text-xl p-3 font-bold cursor-pointer hover:text-stone-500 bg-transparent absolute right-2 top-2">✕</label>
                            <div>
                                <img className='h-[56px] w-[200px] mx-auto mb-5 mt-7' src={threelogo} alt="" />
                                <h1 className='text-red-600 uppercase text-lg text-center'>Create Yor Account</h1>
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 py-6">
                                    <div>
