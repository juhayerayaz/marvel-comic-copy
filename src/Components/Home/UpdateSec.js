...
const UpdateSec = () => {
    ...
    return (
        <div className='mx-40 mt-2 mb-12'>
            ...
            <a href="https://www.marvel.com/insider?cid=dcom_promomodule_20200601_insider_comicspage" target={"_blank"} rel="noreferrer">
            ...
            <div className='grid grid-cols-5 gap-x-5 gap-y-10'>
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/105922/origins_of_marvel_comics_marvel_tales_1_2022_1" target={"_blank"} rel="noreferrer">
                ...
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/105911/ultimate_comics_spider-man_1_facsimile_edition_2022_1" target={"_blank"} rel="noreferrer">
                ...
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/104563/dark_web_x-men_2022_1" target={"_blank"} rel="noreferrer">
                ...
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/103049/star_wars_bounty_hunters_2020_29" target={"_blank"} rel="noreferrer">
                ...
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/102525/legion_of_x_2022_8" target={"_blank"} rel="noreferrer">
                ...
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/102183/the_amazing_spider-man_2022_15" target={"_blank"} rel="noreferrer">
                ...
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/101542/monica_rambeau_photon_2022_1" target={"_blank"} rel="noreferrer">
                ...
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/101529/iron_man_2022_1" target={"_blank"} rel="noreferrer">
                ...
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/98804/savage_avengers_2022_8" target={"_blank"} rel="noreferrer">
                ...
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/98449/planet_hulk_worldbreaker_2022_2" target={"_blank"} rel="noreferrer">
                ...
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/93029/deadpool_2022_2" target={"_blank"} rel="noreferrer">
                ...
                <div className='comics'>
                    <a href="https://www.marvel.com/comics/issue/91347/star_wars_the_mandalorian_2022_6" target={"_blank"} rel="noreferrer">
